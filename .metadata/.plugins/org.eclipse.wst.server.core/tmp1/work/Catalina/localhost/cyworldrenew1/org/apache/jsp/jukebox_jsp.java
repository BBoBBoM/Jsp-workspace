 ...
 * Generated at: 2023-06-02 06:30:07 UTC
...
try {
	...
	e.printStackTrace();
      ...
      out.write("\r\n");
      out.write("\r\n");
      out.write("										<label class=\"music-item\"><a href=\"#\"\r\n");
      out.write("											onclick=\"playaudio('music/");
      out.print(music_subject.get(i));
      out.write(".mp3')\">");
      out.print(music_artist.get(i));
      out.write('-');
      out.print(music_subject.get(i));
      ...
      out.write("							<div id=\"right_music\">\r\n");
      out.write("								<audio id=\"audioPlayer\" controls>\r\n");
      out.write("									<source id=\"audioSource\" src=\"\" type=\"audio/mpeg\">\r\n");
      out.write("								</audio>\r\n");
      out.write("								<button onclick=\"play()\">play</button>\r\n");
      out.write("								<button onclick=\"pre_song()\">pre</button>\r\n");
      out.write("								<button onclick=\"next_song()\">next</button>\r\n");
      out.write("								<p id=\"subjectname\">gdfgdgdfgd</p>\r\n");
      out.write("							</div>\r\n");
      out.write("\r\n");
      out.write("							<script>\r\n");
      out.write("							let src = [\r\n");
...
for (int i = 0; i < music_subject.size(); i++) {
	...
	if (i == music_subject.size() - 1) {
      ...
      out.write("let audioPlayer = document.getElementById('audioPlayer');\r\n");
      out.write("let audioSource = document.getElementById('audioSource');\r\n");
      out.write("let subjectname = document.getElementById('subjectname');\r\n");
      out.write("\r\n");
      out.write("\r\n");
      out.write("\r\n");
      out.write("\r\n");
      ...
      out.write("\r\n");
      out.write("\r\n");
      out.write("function playaudio(name) {\r\n");
      out.write("	audioPlayer.pause();\r\n");
      out.write("	audioSource.src = name;\r\n");
      out.write("	audioPlayer.load();\r\n");
      out.write("	audioPlayer.play();\r\n");
      out.write("	subjectname.innerHTML =name + '재생중'      \r\n");
      out.write("}\r\n");
      out.write("\r\n");
      out.write("function play() {\r\n");
      out.write("    audioPlayer.pause();\r\n");
      out.write("    audioSource.src = \"music/\" + src[currentIndex];\r\n");
      out.write("    audioPlayer.load();\r\n");
      out.write("    audioPlayer.play();\r\n");
      out.write("    subjectname.innerHTML = src[currentIndex] + ' 재생중';\r\n");
      out.write("\r\n");
      out.write("  \r\n");
      out.write("}\r\n");
      out.write("\r\n");
      out.write("\r\n");
      out.write("function pre_song() {\r\n");
      out.write("	if (currentIndex === 0) {\r\n");
      out.write("		currentIndex = src.length - 1;\r\n");
      out.write("	} else {\r\n");
      ...
      out.write("}\r\n");
      out.write("\r\n");
      out.write("function next_song() {\r\n");
      out.write("	if (currentIndex === src.length - 1) {\r\n");
