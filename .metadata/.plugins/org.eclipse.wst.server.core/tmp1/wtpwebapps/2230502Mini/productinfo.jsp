...
<style>
#proinfodiv{float:left;}}
    #proimgdiv{width: 500px;height: 500px;float:left;}
    img{width: 450px;height: 450px;background-position: center;background-repeat: no-repeat;background-size: cover;box-sizing:border-box;}
    #proinfoAll{float:left; }
</style>
</head>
...
<div id="proinfoAll">
<div id="proimgdiv" ><img src="<%=imageName%>"></div>
<div id="proinfodiv">
제품코드: <%=productId %><br>
제품이름:<%=pname %><br>
제품가격:<%=unitPrice %><br>
...
제조사:<%=maker %><br>
제품분류:<%=category %><br>
제품재고:<%= unitsinstock%><br>
제품상태:<%=condition %><br></div></div>
<form action="product.jsp">
<input type="submit" value="상품목록으로"></form>
