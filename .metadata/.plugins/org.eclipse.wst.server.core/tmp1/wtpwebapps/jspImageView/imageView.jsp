            ...
            if (typeof(FileReader) != "undefined") {
              ...
              for (var i = 0; i < countFiles; i++) 
              {
            	//파일을 읽어들일 객체생성
          		...
          		//e는 현재발생한 이벤트 객체(정보)
          		//e.target는 현재 이벤트가 발생한 요소 객체(이벤트를 당한 객체)
          		//e.target.result는 읽어들인 파일 객체의 고유한 URL
          		//thumb-image class로 정의하고 CSS적용
    			...
    			//src속성값을 이용하여 미리보기 image-holder를 통해서 
                image_holder.show();
...
<body>
	<div id="wrapper" style="margin-top: 20px">
		...
		<!--type=file 기본적으로 하나의 파일만 선택가능   multiple 명시해주면 복수선택가능 -->
