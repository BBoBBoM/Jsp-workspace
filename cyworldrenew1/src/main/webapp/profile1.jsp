...
<body>
							...
							<div id="center_contents">
								...
								<div id="center_profile_content">
									...
									<div id="profile_introduce_border1">
										...
										<button onclick="showTextArea()"style="float:right">수정하기</button>
									...
									<div id="profile_introduce_border2" style="display: none;">
										<form action="saveText.jsp" method="post">
											...
											<textarea id="filecontent_textarea"
												name="filecontent_textarea"></textarea>
										</form>
									</div>
								</div>
    ...
    window.addEventListener("load", function() {
        ...
        xhr.open("GET","<%=user_id%>.txt", true); // 표시할 파일의 경로와 파일명을 지정합니다.
        ...
        xhr.open("GET","<%=user_id%>.txt",
									...
									function saveText() {
										var fileContent = document
												.getElementById("filecontent_textarea").value;

										var xhr = new XMLHttpRequest();
										xhr.open("POST", "saveText.jsp", true); // 데이터를 전송할 JSP 파일 경로를 지정합니다.
										xhr
												.setRequestHeader(
														"Content-Type",
										...
										xhr
												.send("text="
														+ encodeURIComponent(fileContent)); // 데이터를 전송합니다.
