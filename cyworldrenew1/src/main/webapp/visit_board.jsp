...
try {
	String sql = "select * from visit_board where user_id=? order by visit_date DESC; ";
	pstmt = conn.prepareStatement(sql);
	pstmt.setString(1, user_id);
	ResultSet rs = pstmt.executeQuery();
	while (rs.next()) {
		String visit_contents1 = rs.getString("visit_contents");
		String visit_date1 = rs.getString("visit_date");
		String ilchon_id1 = rs.getString("ilchon_id");
						...
						<div id="center_contents">
							<div id="center_photocontentsdiv">
								<div id="center_photocontentsdiv1">
									<div id="center_photo_calendar"></div>
